...
interface HeroSectionProps {
  config: CrossDockServicesConfig["hero"];
  contactBox: CrossDockServicesConfig["contactBox"];
  className?: string;
}
      ...
      <div className="container mx-auto px-4 lg:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-header-teal rounded-xl p-6 lg:p-8 text-header-text-on-dark border-2 border-white">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-2xl lg:text-3xl font-bold text-white hover:text-header-orange transition-colors"
                >
